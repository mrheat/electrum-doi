...
class CoinCap(ExchangeBase):
    ...
    async def get_rates(self, ccy):
        # CoinCap rates API is broken for Doichain.  Use history API instead.
        """
...
class CoinGecko(ExchangeBase):
    ...
    async def get_rates(self, ccy):
        # CoinGecko exchange_rates API is unavailable for Doichain.  Use coins API instead.
        """
