...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electrum-doi create'")
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-doi setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-doi setconfig' to change your settings")
        return True
