...
The Kivy GUI is used with Electrum-DOI on Android devices.
...
2. Build image
    ...
    ```
    $ sudo docker build -t electrum-doi-android-builder-img electrum_doi/electrum/gui/kivy/tools
    ```
...
5. Build binaries
    ...
    $ sudo docker run -it --rm \
        --name electrum-doi-android-builder-cont \
        -v $PWD:/home/user/wspace/electrum \
        -v $PWD/.buildozer/.gradle:/home/user/.gradle \
        -v ~/.keystore:/home/user/.keystore \
        --workdir /home/user/wspace/electrum \
        electrum-doi-android-builder-img \
        ./contrib/make_apk
    ```
...
$ adb shell monkey -p org.namecoin.electrum_doi.electrum_doi 1
```
...
Build atlas: `(cd electrum_doi/electrum/gui/kivy/; make theming)`

Run electrum-doi with the `-g` switch: `electrum-doi -g kivy`
