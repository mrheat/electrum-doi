...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.namecoin.electrum_doi.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.namecoin.electrum_doi"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.namecoin.electrum_doi:externalType",
                '',
                data)
        return extRecord
    ...
    def _nfc_enable_ndef_exchange(self, data):
        ...
        ndef_record = NdefRecord(
                ...
                'org.namecoin.electrum_doi.kivy', '', data)
