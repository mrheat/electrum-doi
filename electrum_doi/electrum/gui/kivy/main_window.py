...
# the data
Cache.register('electrum_doi_widgets', timeout=0)
...
Label.register('Roboto',
               'electrum_doi/electrum/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_doi/electrum/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_doi/electrum/gui/kivy/data/fonts/Roboto-Bold.ttf',
               'electrum_doi/electrum/gui/kivy/data/fonts/Roboto-Bold.ttf')
...
class ElectrumWindow(App):
    ...
    def build(self):
        return Builder.load_file('electrum_doi/electrum/gui/kivy/main.kv')
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            popup = Builder.load_file('electrum_doi/electrum/gui/kivy/uix/ui_screens/'+name+'.kv')
    ...
    def init_ui(self):
        ...
        #Cache.append('electrum_doi_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_doi_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "electrum_doi/electrum/gui/icons/electrum_doi.png"
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-DOI', message,
                            app_icon=icon, app_name='Electrum-DOI')
        except ImportError:
    ...
    def show_error(self, error, width='200dp', pos=None, arrow_pos=None,
                   exit=False, icon='atlas://electrum_doi/electrum/gui/kivy/theming/light/error', duration=0,
                   modal=False):
    ...
    def show_info(self, error, width='200dp', pos=None, arrow_pos=None,
        ...
        '''
        self.show_error(error, icon='atlas://electrum_doi/electrum/gui/kivy/theming/light/important',
    ...
    def show_info_bubble(self, text=_('Hello World'), pos=None, duration=0,
        ...
        if text == 'texture':
            ...
            info_bubble.background_image = 'atlas://electrum_doi/electrum/gui/kivy/theming/light/card'
        else:
