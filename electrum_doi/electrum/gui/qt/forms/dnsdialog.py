...
# Form implementation generated from reading ui file 'electrum_doi/electrum/gui/qt/forms/dnsdialog.ui'
#
...
class Ui_DNSDialog(object):
    def setupUi(self, DNSDialog):
        ...
        self.dialogButtons = QtWidgets.QDialogButtonBox(DNSDialog)
    ...
    def retranslateUi(self, DNSDialog):
        ...
        self.labelADesc.setText(_translate("DNSDialog", "Enter a hostname to direct .bit requests. Doichain A records are for IPv4, IPv6, tor, freenet, i2p addresses only and tell a request where your domain should direct to."))
        ...
        self.labelAHostname.setText(_translate("DNSDialog", "Hostname"))
        self.editAHostname.setPlaceholderText(_translate("DNSDialog", "e.g., 192.168.0.1, eqt5g4fuenphqinx.onion"))
        ...
        self.labelCNAMEDesc.setText(_translate("DNSDialog", "CNAME records act as an alias by mapping a hostname to another hostname. Absolute domain names end with a dot (.)."))
        ...
        self.labelSRVDesc.setText(_translate("DNSDialog", "Used to identify hosts that support particular services (e.g., imap, pop, https, etc) as per DNS SRV records. In the host field, absolute domain names end with a dot (.)."))
...
""))
        ...
        self.labelIMPORTDesc.setText(_translate("DNSDialog", "Imports specified entries from Doichain names and merges with the current one. Optionally, import entries and associate them with a designated subdomain."))
        self.labelIMPORTName.setText(_translate("DNSDialog", "Doichain Name"))
        ...
        self.labelSSHFPDesc.setText(_translate("DNSDialog", "SSHFP records are used to identify an SSH fingerprint associated with a domain."))
        ...
        self.tabRecords.setTabText(self.tabRecords.indexOf(self.tabSSHFP), _translate("DNSDialog", "SSHFP"))
