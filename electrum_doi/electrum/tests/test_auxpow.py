...
class Test_auxpow(SequentialTestCase):
    ...
    # Deserialize the AuxPoW header from Doichain block #37,174.
    ...
    # Verify the AuxPoW header from Doichain block #37,174.
    ...
    # Verify the AuxPoW header from Doichain block #19,414.  This header
    ...
    # parser).  We use this Doichain header because it has an explicit MM
