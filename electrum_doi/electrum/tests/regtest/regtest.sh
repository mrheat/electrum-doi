...
alice="./run_electrum_doi --regtest -D /tmp/alice"
bob="./run_electrum_doi --regtest -D /tmp/bob"
carol="./run_electrum_doi --regtest -D /tmp/carol"
...
function wait_for_balance()
{
    ...
    cmd="./run_electrum_doi --regtest -D /tmp/$1"
...
if [[ $1 == "init" ]]; then
    echo "initializing $2"
    rm -rf /tmp/$2/
    agent="./run_electrum_doi --regtest -D /tmp/$2"
