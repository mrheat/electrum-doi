...
class Test_bitcoin(ElectrumTestCase):
    ...
    def test_msg_signing(self):
        ...
        # Due to a difference in low-r signing, Doichain Core and Electrum-DOI
        # produce different signatures.  The values here are produced by
        # Electrum-DOI but have been checked to verify with Doichain Core.
...
class Test_keyImport(ElectrumTestCase):
    ...
    def test_is_address_bad_checksums(self):
        # Doichain: frombtc raises an AssertionError when an invalid
