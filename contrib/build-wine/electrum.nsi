...
;Variables
  ...
  !define PRODUCT_PUBLISHER "Doichain Project"
...
;General
  ...
  ;Name and file
  Name "${PRODUCT_NAME}"
  OutFile "dist/electrum-doi-setup.exe"
...
;Interface Settings
  ...
  !define MUI_ICON "c:\electrum-doi\electrum_doi\electrum\gui\icons\electrum_doi.ico"
...
Section
  ...
  File "c:\electrum-doi\electrum_doi\electrum\gui\icons\electrum_doi.ico"
  ...
  WriteRegStr HKCU "Software\Classes\namecoin" "DefaultIcon" "$\"$INSTDIR\electrum_doi.ico, 0$\""
  WriteRegStr HKCU "Software\Classes\namecoin\shell\open\command" "" "$\"$INSTDIR\electrum-doi-${PRODUCT_VERSION}.exe$\" $\"%1$\""
  ...
  WriteRegStr HKCU "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\electrum_doi.ico"
