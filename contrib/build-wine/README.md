...
2. Build image
    ...
    ```
    $ sudo docker build -t electrum-doi-wine-builder-img contrib/build-wine
    ```
...
Electrum-DOI Windows builds are signed with a Microsoft Authenticode™ code signing
certificate in addition to the GPG-based signatures.

The advantage of using Authenticode is that Electrum-DOI users won't receive a 
...
|-----------------------------------------------------------------------------------------------|
| Upload signatures to 'electrum-doi-signatures' repo, as `$version/$filename.$builder.asc`         |
