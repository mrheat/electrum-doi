...
This guide explains how to build Electrum-DOI binaries for macOS systems.
...
#### 2. Build Electrum-DOI

    cd electrum-doi
    ./contrib/osx/make_osx

This creates both a folder named Electrum-DOI.app and the .dmg file.
